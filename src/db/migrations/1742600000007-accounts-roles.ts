...
export const up = async (db: Kysely<any>): Promise<void> => {
  await db.schema
    ...
    .addPrimaryKeyConstraint('accounts_roles_pk', ['account_id', 'account_role_id'])
    .addForeignKeyConstraint('accounts_roles_account_id_fk', ['account_id'], 'accounts', ['id'], fk => fk.onUpdate('cascade').onDelete('cascade'))
    .addForeignKeyConstraint('accounts_roles_account_role_id_fk', ['account_role_id'], 'account_roles', ['id'], fk => fk.onUpdate('cascade').onDelete('cascade'))
    .execute();
};
